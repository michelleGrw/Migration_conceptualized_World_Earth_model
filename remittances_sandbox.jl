...
parsecn = @parameters a = 0.04 b = 0.04 c = 0.0 γ = 0.0016 Ypc0 = 10 δ₁=0.05 δ₂=0.05 α₁=0.5 α₂=0.5 s₁=0.25 s₂=0.21 Cₘ₁=0.7 Cₘ₂=0.7 a₁=2.7 a₂=1.7 #economic dynamics
parsear = @parameters r = 0 re₁=0.1 re₂=0.1 eb=0.00004 u=0.0025 α=0.1 σ₁=0.03 σ₂=0.03 G₀=20 G₁=5 Tg=50 η=1 #earth system and climate 
...
## migratipon rates 
m21 = gdp2_ij(Y₁,P₁,Y₂,P₂).*0.03 - pop2.*0.03 + 0.01*θ(P₂-P_kp)
m21_gp = gdp2_ij(Y₁_gp,P₁_gp,Y₂_gp,P₂_gp).*0.03 - pop2_gp.*0.03 +0.01*θ(P₂_gp-P_kp_gp)
m21_gpc = gdp2_ij(Y₁_gpc,P₁_gpc,Y₂_gpc,P₂_gpc).*0.03 - pop2_gpc.*0.03 + 0.01*θ(P₂_gpc-kp_2_gpc)
m21_gpcr = gdp2_ij(Y₁_gpcr,P₁_gpcr,Y₂_gpcr,P₂_gpcr).*0.03 - pop2_gpcr.*0.03 + 0.01*θ(P₂_gpcr-kp_2_gpcr)
...
plot!(sol[P₁_gpcr],color = "dodgerblue2", label = false,linestyle=:dashdot);
plot!(sol[P₂_gpcr],color = "orangered", label = false, ylims= (0,40),linestyle=:dashdot);
plot!(sol[P₂_gpcr+P₁_gpcr],color="grey", label = false,linestyle=:dashdot);
...
##population on time 
plot(sol[P₁/P₂],label="a=0.03,b=0.03,c=0.01,r=0")
plot!(sol[P₁_gp/P₂_gp],label="a=0.03,b=0.03,c=0.01,r=0.05")
plot!(sol[P₁_gpc/P₂_gpc],label="a=0.03,b=0.03,c=0.01,r=0.1")
plot!(sol[P₁_gpcr/P₂_gpcr],label="a=0.03,b=0.03,c=0.01,r=0.15")
...
# plot(sol[G*100],sol[P₁+P₂],label="a=0.04, b=0.04, r=0.1")
# plot!(sol[G_gp*100],sol[P₁_gp+P₂_gp],label="a=0.04, b=0.03, r=0.1")
# plot!(sol[G_gpc*100],sol[P₁_gpc+P₂_gpc],label="a=0.03,b=0.04,r=0.1")
# plot!(sol[G_gpcr*100],sol[P₁_gpcr+P₂_gpcr],label="a=0.03,b=0.04,r=0.1")
# p7 = plot!(sol[G_nomig]*100,sol[P1_nomig+P2_nomig], label = "m=0", title = "Externality vs Popuation", xlabel = "atm CO2 (ppm)", ylabel = "total world pop (billion ppl)")


# plot(sol[(G*100)/(P₁+P₂)],label="a=0.04,b=0.04,r=0.1")
# plot!(sol[(G_gp*100)/(P₁_gp+P₂_gp)],label="a=0.04,b=0.03,r=0.1")
# plot!(sol[(G_gpc*100)/(P₁_gpc+P₂_gpc)],label="a=0.03,b=0.04,r=0.1")
# plot!(sol[(G_gpc*100)/(P₁_gpc+P₂_gpc)],label="a=0.03, b=0.03,r=0.1")
# p7 = plot!(sol[(G_nomig*100)/(P1_nomig+P2_nomig)], label = "m=0", title = "Externality/Popuation", xlabel = "time", ylabel = "G/worldpop")
